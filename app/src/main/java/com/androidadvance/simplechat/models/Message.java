...
public class Message {
  ...
  public Message(String userID, String username, String message, long timestamp, boolean isNotification) {
    this.userID = userID;
    this.username = username;
    this.message = message;
    this.timestamp = timestamp;
    this.isNotification = isNotification;
    this.fromAdmin = false; // Assuming default value for fromAdmin is false
  }
